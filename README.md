...
| 功能 | 说明 |
|------|------|
| 🎯 **多数据源** | 支持 QQ音乐、网易云、酷狗、酷我、iTunes、MusicBrainz 等 6 大数据源 |
...
| 数据源 | 特点 | 推荐场景 |
|--------|------|---------|
| **QQ音乐** | 华语覆盖全，封面高清 | 华语歌曲首选 |
| **网易云音乐** | 华语覆盖好，有歌词 | 华语歌曲备选 |
| **酷狗音乐** | 歌词资源丰富 | 获取歌词 |
| **酷我音乐** | 曲库较全 | 备用数据源 |
| **iTunes** | 欧美日韩覆盖好 | 外语歌曲 |
| **MusicBrainz** | 开放数据库，数据规范 | 专业用户 |
...
```bash
# 克隆项目
git clone https://github.com/your-username/music-scraper.git
cd music-scraper
...
- 🎉 首个公开发布版本
- ✅ 支持 6 大数据源（QQ音乐、网易云、酷狗、酷我、iTunes、MusicBrainz）
- ✅ 智能置信度匹配算法
- ✅ 多源数据互补
- ✅ 批量自动刮削
- ✅ 歌词自动获取
